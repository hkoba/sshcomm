...
> [plugins-and-hostsetup.md](plugins-and-hostsetup.ja.md) を参照。
...
> 設計の詳細・残課題は [improvement-notes.md](todo/improvement-notes.ja.md) §0。
...
> 詳細は [plugins-and-hostsetup.md](plugins-and-hostsetup.ja.md) §1。
...
> **実験的（テスト免除）**。コードにも `# EXPERIMENTAL` を明記。[README.md](README.ja.md) の凡例参照。
...
> 詳細と整理案は [improvement-notes.md](todo/improvement-notes.ja.md) を参照。
